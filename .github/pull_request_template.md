...
- [ ] For kernel cases with `author_tests`, I have linked independent-reference and comparator-sensitivity results for the changed revision and stated any pending GPU validation. I have also linked representative forward/backward timing evidence or explained why it is pending; accuracy and replay passes do not establish performance.
