...
""",
    ...
    def test_pr_defaults_to_selection_and_preserves_functional_label_scope(self):
        cases = [
            ([], "L0", "2", "false"),
            (["Run tests"], "L1", "1", "true"),
    ...
    def test_full_unit_override_is_independent_of_functional_scope(self):
        outputs = self._configure(["Run full unit tests"])
    ...
    def test_non_pr_triggers_and_preflight_override_use_full_units(self):
        ...
        for environment in cases:
            with self.subTest(environment=environment):
                self.assertEqual(self._configure(**environment)["selective_tests"], "false")
