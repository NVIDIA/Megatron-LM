...
* Features  
  * Inference  
    * Add async support for DynamicInferenceEngine ([MR \!3187](https://gitlab-master.nvidia.com/ADLR/megatron-lm/-/merge_requests/3187))  
    * Pad input tensors and enable FP8 weights for FP8 inference ([MR \!3341](https://gitlab-master.nvidia.com/ADLR/megatron-lm/-/merge_requests/3341))  
    * Force inference to always gather logits with tensor parallelism ([MR \!3442](https://gitlab-master.nvidia.com/ADLR/megatron-lm/-/merge_requests/3442))  
    * Multi batch size CUDA Graphs for Dynamic Inference ([MR \!3402](https://gitlab-master.nvidia.com/ADLR/megatron-lm/-/merge_requests/3402))  
  * Post-training  
    * ModelOpt updates ([MR \!3268](https://gitlab-master.nvidia.com/ADLR/megatron-lm/-/merge_requests/3268))  
      * Add speculative decoding AR validation feature  
      * Add DeepSeek and Qwen model configs  
  * Performance  
    * ModelCommProcessGroup integration ([MR \!3391](https://gitlab-master.nvidia.com/ADLR/megatron-lm/-/merge_requests/3391))  
    * Add HyperCommGrid: N-Dimensional Communication Grid for Model Parallelism ([MR \!3398](https://gitlab-master.nvidia.com/ADLR/megatron-lm/-/merge_requests/3398))  
      * Flexible creation and management of communication groups  
    * Add support for Spike No More embedding initializations and weight decay skipping ([MR \!3500](https://gitlab-master.nvidia.com/ADLR/megatron-lm/-/merge_requests/3500))  
  * MoE  
    * @zijie  
  * Model support  
  ...
  * Ease of use  
    * Add uv support for source installs ([MR \!3615](https://gitlab-master.nvidia.com/ADLR/megatron-lm/-/merge_requests/3615))  
    * Automated weekly prereleases ([MR \!3574](https://gitlab-master.nvidia.com/ADLR/megatron-lm/-/merge_requests/3574))  
* Bug fixes  
  * Use mscale\_all\_dim for softmax\_factor ([MR \!2800](https://gitlab-master.nvidia.com/ADLR/megatron-lm/-/merge_requests/2800))  
  * Fix FP8 param blockwise scaling unit test ([MR \!3480](https://gitlab-master.nvidia.com/ADLR/megatron-lm/-/merge_requests/3480))  
  * Fix unit test blockwise scaling ([MR \!3491](https://gitlab-master.nvidia.com/ADLR/megatron-lm/-/merge_requests/3491))  
  * Optimize prefill for token-less requests ([MR \!3499](https://gitlab-master.nvidia.com/ADLR/megatron-lm/-/merge_requests/3499))  
  * Add default values for Fp8Padding and Fp8Unpadding ([MR \!3501](https://gitlab-master.nvidia.com/ADLR/megatron-lm/-/merge_requests/3501))  
  * Fix CUDA graph logic for flexible pp layout ([MR \!3505](https://gitlab-master.nvidia.com/ADLR/megatron-lm/-/merge_requests/3505))  
  * Load FP8 models with strict=False ([MR \!3508](https://gitlab-master.nvidia.com/ADLR/megatron-lm/-/merge_requests/3508))  
  * Skip rope check for torch \< 1.4.0 ([MR \!3528](https://gitlab-master.nvidia.com/ADLR/megatron-lm/-/merge_requests/3528))  
  * Disable Apex tests for stability ([MR \!3539](https://gitlab-master.nvidia.com/ADLR/megatron-lm/-/merge_requests/3539))  
  * Fix typo in parallel\_state expert parallelism ([MR \!3548](https://gitlab-master.nvidia.com/ADLR/megatron-lm/-/merge_requests/3548))  
  * Guard modelopt on macOS ([MR \!3549](https://gitlab-master.nvidia.com/ADLR/megatron-lm/-/merge_requests/3549))  
  * Retry on CUDA function failure ([MR \!3554](https://gitlab-master.nvidia.com/ADLR/megatron-lm/-/merge_requests/3554))  
  * Fix NCCL mem pool creation error ([MR \!3557](https://gitlab-master.nvidia.com/ADLR/megatron-lm/-/merge_requests/3557))  
  * Fix get\_rotary\_seq\_len return type ([MR \!3559](https://gitlab-master.nvidia.com/ADLR/megatron-lm/-/merge_requests/3559))  
  * Retry on CUDA function failure ([MR \!3560](https://gitlab-master.nvidia.com/ADLR/megatron-lm/-/merge_requests/3560))  
  * Fix NCCL allocator attribute error ([MR \!3565](https://gitlab-master.nvidia.com/ADLR/megatron-lm/-/merge_requests/3565))  
  * Ensure multi-prompt inference works ([MR \!3568](https://gitlab-master.nvidia.com/ADLR/megatron-lm/-/merge_requests/3568))  
  * Fix MD5 on FIPS systems ([MR \!3577](https://gitlab-master.nvidia.com/ADLR/megatron-lm/-/merge_requests/3577))  
  * Fixes dynamic context and inference bugs ([MR \!3582](https://gitlab-master.nvidia.com/ADLR/megatron-lm/-/merge_requests/3582))  
  * Fix TE version for interleaved fused RoPE ([MR \!3586](https://gitlab-master.nvidia.com/ADLR/megatron-lm/-/merge_requests/3586))  
  * Fix MTP with MoE and TP logging ([MR \!3594](https://gitlab-master.nvidia.com/ADLR/megatron-lm/-/merge_requests/3594))  
  * Guard TE import fix ([MR \!3596](https://gitlab-master.nvidia.com/ADLR/megatron-lm/-/merge_requests/3596))  
  * Add assertion for NCCL UB case ([MR \!3599](https://gitlab-master.nvidia.com/ADLR/megatron-lm/-/merge_requests/3599))  
  * Remove Encoder PP related Functions ([MR \!3604](https://gitlab-master.nvidia.com/ADLR/megatron-lm/-/merge_requests/3604))  
  * Fix segfaults in tests ([MR \!3605](https://gitlab-master.nvidia.com/ADLR/megatron-lm/-/merge_requests/3605))  
  * Fix TE error in distributed optimizer ([MR \!3625](https://gitlab-master.nvidia.com/ADLR/megatron-lm/-/merge_requests/3625))  
  * Remove redundant barrier in checkpoint flow ([MR \!3626](https://gitlab-master.nvidia.com/ADLR/megatron-lm/-/merge_requests/3626))  
  * Support VPP MTP, fix logging ([MR \!3630](https://gitlab-master.nvidia.com/ADLR/megatron-lm/-/merge_requests/3630))  
  * Retry mechanism for free(): invalid pointer errors ([MR \!3632](https://gitlab-master.nvidia.com/ADLR/megatron-lm/-/merge_requests/3632))  
  * Fix test\_replication.py issues ([MR \!3633](https://gitlab-master.nvidia.com/ADLR/megatron-lm/-/merge_requests/3633))  
  * Fix typo in parallel\_state ([MR \!3634](https://gitlab-master.nvidia.com/ADLR/megatron-lm/-/merge_requests/3634))  
  * Fix CUDA graph logic determination ([MR \!3635](https://gitlab-master.nvidia.com/ADLR/megatron-lm/-/merge_requests/3635))  
  * Fix TE installation error ([MR \!3636](https://gitlab-master.nvidia.com/ADLR/megatron-lm/-/merge_requests/3636))  
  * Ensure correct sharding type in local tests ([MR \!3643](https://gitlab-master.nvidia.com/ADLR/megatron-lm/-/merge_requests/3643))  
  * Fix cudagraphed backward buffer reuse for last layer ([MR \!3645](https://gitlab-master.nvidia.com/ADLR/megatron-lm/-/merge_requests/3645))  
  * Set default for packed\_seq\_params in get\_rotary\_seq\_len ([MR \!3651](https://gitlab-master.nvidia.com/ADLR/megatron-lm/-/merge_requests/3651))  
  * Fix dynamic example script errors ([MR \!3653](https://gitlab-master.nvidia.com/ADLR/megatron-lm/-/merge_requests/3653))  
  * Guard TE import fix ([MR \!3666](https://gitlab-master.nvidia.com/ADLR/megatron-lm/-/merge_requests/3666))  
* Breaking changes:  
