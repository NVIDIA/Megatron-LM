...
- **[2026/06]** **[DeepSeek-V4 initial support](https://github.com/NVIDIA-NeMo/Megatron-Bridge/tree/main/examples/models/deepseek_v4)** - Megatron Bridge now includes conversion, inference, and pretraining recipes for the DeepSeek-V4 family.
