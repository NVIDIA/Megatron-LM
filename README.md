...
- **[2026/03]** **Deprecating Python 3.10 support:** We are officially dropping Python 3.10 support with the upcoming 0.17.0 release. Downstream applications must raise their lower boundary to 3.12 to stay compatible with MCore.
