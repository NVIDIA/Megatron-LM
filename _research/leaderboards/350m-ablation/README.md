...
| ---: | --- | --- | --- | --- | ---: | ---: | ---: | --- | --- | --- |
| 1 | aurora-qkn-xsa | aurora-qkn | add `--exclusive-self-attention` (XSA, GQA-aware + torch.compile) | Aurora + QK norm + XSA | 1e-2 | **2.167** | **2.009** | [`12-aurora-qkn-xsa.sbatch`](runs/12-aurora-qkn-xsa.sbatch) | [mdmnb7mc](https://wandb.ai/ischlag/lm-research-baseline-dev/runs/mdmnb7mc) | [`435b3cf2d`](https://github.com/ischlag/megatron-lm-research-baseline/tree/435b3cf2d) |
