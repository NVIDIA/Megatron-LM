...
- **[2024/06]** Megatron Core added support for Mamba-based models. Review the paper [An Empirical Study of Mamba-based Language Models](https://arxiv.org/pdf/2406.07887) and [code example](https://github.com/NVIDIA/Megatron-LM/tree/df61e60bf5670b1196fcae2264311401d3bb82db/examples/mamba).
