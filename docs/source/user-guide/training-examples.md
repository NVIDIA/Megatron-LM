...
- **Optimize Performance**: See [Advanced Features](../advanced-features/index.html) for FSDP, distributed optimizer, and other optimizations
- **Scale Up**: Learn about [Parallelism Strategies](parallelism-guide.html) to train larger models across more GPUs
- **Prepare Data**: Follow the [Data Preparation](data-preparation.html) guide to process your own datasets
