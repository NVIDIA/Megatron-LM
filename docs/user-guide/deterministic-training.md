...
For cross-run investigations, use
[rank-local determinism tracing](determinism-tracing.md) to capture progressively
stronger evidence and locate the first semantic boundary that diverges.
