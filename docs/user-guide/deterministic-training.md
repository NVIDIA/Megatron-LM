...
CI performance uses repeated unprofiled pairs and reports confidence intervals.
Nsight breakdowns are separate diagnostics. See the
[performance guide](../developer/determinism/performance.md) for calibration.
