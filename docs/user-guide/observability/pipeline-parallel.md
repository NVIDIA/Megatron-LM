...
[lens: distributed tracing](https://github.com/NVIDIA-NeMo/Lens/blob/main/docs/user-guide/distributed-tracing.mdx)
for how they work.
...
See [lens: distributed tracing](https://github.com/NVIDIA-NeMo/Lens/blob/main/docs/user-guide/distributed-tracing.mdx) for a deeper discussion.
