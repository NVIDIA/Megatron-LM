...
NAME="${NAME}-ep-pyramid-64+128-mos-test2-mlc-${MLC}-cap-${MOE_TRAIN_CAP_FACTOR}-drop-${MOE_DROP_TOKEN}"
...
KD_BETA_CE=1
CHECKPOINT_PATH_STUDENT="/blob/users/minjiaz/checkpoint/${NAME}"
# CHECKPOINT_PATH_TEACHER="/blob/users/zheweiyao/checkpoint/gpt3_1.3b_lora_moe_ep_64_pyramid_10x64+2x128_lr_1.2e-4_MLR_1.0_330B"
CHECKPOINT_PATH_TEACHER="~/workspace/moe/DeepSpeed-public-mos-release/Megatron-DeepSpeed-MoS/examples/MoE/output/checkpoint/gpt-1.3B-lr-1.2e-4-minlr-1.0e-6-bs-512-gpus-128-mp-1-pp-1-ep-pyramid-64+128-mlc-0.01-cap-1.0-drop-true/"
CHECKPOINT_PATH_SAVE="/blob/users/minjiaz/checkpoint/${NAME}"
