...
DATA_CACHE_PATH="/home/scratch.sagdesai_wwfo/megatron-lm-fp8/benchmark_cache_llama3_8b_bf16"
...
EVAL_AND_LOGGING_ARGS=(
    --log-interval 1
    # --eval-iters 32 # had to disable, due to convergence issues
    # --eval-interval 100 # had to disable, due to convergence issues
    --save-interval 1000
    --log-throughput
    --profile
    ...
    --wandb-exp-name "llama3x-8b-bf16-tp1"
