...
# Optional: Uncomment and configure these for additional performance tuning
...
CHECKPOINT_PATH=${1:-"/home/scratch.sagdesai_wwfo/megatron-lm-fp8/checkpoints/llama3_8b_fp8"}
TENSORBOARD_LOGS_PATH=${2:-"/home/scratch.sagdesai_wwfo/megatron-lm-fp8/tensorboard_logs/llama3_8b_fp8"}
TOKENIZER_ARG=${3:-"/home/scratch.sagdesai_wwfo/datasets/slimpajama/tokenizer"} # Path to tokenizer model, or "MOCK"
DATA_ARG="$(cat /home/scratch.sagdesai_wwfo/datasets/slimpajama/slimpajama_processed/dataset_paths.txt | tr '\n' ' ')"   # Data directory, or "MOCK"
...
DATA_CACHE_PATH="/home/scratch.sagdesai_wwfo/megatron-lm-fp8/benchmark_cache_llama3_8b_fp8"
...
EVAL_AND_LOGGING_ARGS=(
    ...
    --wandb-exp-name "llama3x-8b-fp8-tp1_cs_1F1L"
...
/bin/python -m torch.distributed.run \
    ${DISTRIBUTED_ARGS[@]} \
