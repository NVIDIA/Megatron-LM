...
# FP8 specific arguments - COMMENTED OUT FOR BF16 TRAINING
FP8_ARGS=(
    --transformer-impl transformer_engine  # Required for fp8
    --fp8-format hybrid                    # Use hybrid fp8 format (recommended)
    --fp8-recipe delayed                   # Use delayed scaling recipe
    ...
    --attention-softmax-in-fp32           # Keep attention softmax in fp32 for stability
)
...
EVAL_AND_LOGGING_ARGS=(
    ...
    --wandb-exp-name "llama3x-small-slimpajama-fp8-delayed"
