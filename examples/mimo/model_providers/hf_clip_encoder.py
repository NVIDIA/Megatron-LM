...
from transformers.models.llava_next_video.modeling_llava_next_video import LlavaNextVideoPooler
...
class HFCLIPEncoderWrapper(torch.nn.Module):
    ...
    def __init__(self, feature_layer_index=-2, is_video_input: bool = False):
        ...
        Args:
            feature_layer_index (int): Index of the feature layer to
                extract from the encoder's hidden states.
    ...
    def forward(self, pixel_values: torch.Tensor):
        """Input: (B, F, 3, 336, 336) if video, else (B, 3, 336, 336) or (num_frames, 3, 336, 336)."""  # noqa: E501
