...
def model_provider(
    ...
    if args.decoder_seq_length > args.max_position_embeddings:
        ...
        warnings.warn(
            f"Expanded max_position_embeddings to {args.max_position_embeddings} to accommodate the maximum language model sequence length"  # noqa: E501
        )
    ...
    # Make sure vision model pipeline parallel size is not inherited from the language model pipeline parallel size.  # noqa: E501
    vision_config.pipeline_model_parallel_size = 1
    vision_projection_config.pipeline_model_parallel_size = (
        vision_config.pipeline_model_parallel_size
    )

    # Make sure the vision model does not inherit first and last pipeline num layers from the language model.  # noqa: E501
    ...
    assert image_token_index is not None, (
