...
class MultimodalModel(MegatronModule):
    ...
    supports_ep_a2a_overlap_schedule = True
    ...
    def build_schedule_plan(
        ...
        **kwargs,
        ...
        """Build an EP A2A-overlap schedule for the language decoder.

        The multimodal wrapper owns vision encoding and text/vision embedding
        composition.  Those steps are kept on the eager path; the schedule plan
        itself is delegated to the inner GPT decoder, which is where MoE A2A
