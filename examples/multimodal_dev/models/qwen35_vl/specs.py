...
"""Layer spec helpers for the Qwen3.5-VL vision encoder.

The language decoder uses the standard HybridModel stack spec; its concrete
GatedDeltaNet / attention / MLP ordering is defined by ``hybrid_layer_pattern``.
"""
