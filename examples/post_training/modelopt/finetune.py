...
def get_eos_id():
    ...
    We insert eos_token between two samples during packing. However, if
    the eos_token is used in message or after turns, we need to replace it
    with some other special tokens that do not appear in message."""
...
class SFTDataset(torch.utils.data.Dataset):
    ...
    hf_dataset_to_conversation = {
        ...
        "Magpie-Align/Magpie-Llama-3.1-Pro-MT-300K-Filtered": lambda data: (
            SFTDataset._sharegpt_to_openai_conversations(  # noqa: E501
                data
            )
        ),
    }
    ...
    def __init__(
        ...
        hf_dataset_kwargs = SFTDataset.hf_dataset_to_kwargs.get(self.hf_dataset, {"split": "train"})
