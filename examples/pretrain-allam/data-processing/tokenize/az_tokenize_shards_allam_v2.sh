TOK_MODEL="https://allamllmuksstandard.blob.core.windows.net/llm-data/allam-v2-data/allam_v2_tokenize_by_v5tok.improved/tokenizer_v5_improved/ar_en.model"
...
BIN_IDX_PATH="https://allamllmuksstandard.blob.core.windows.net/llm-data/allam-v2-data/allam_v2_tokenize_by_v5tok.improved/meglm_tok_v5_improved_bin_idx"
