TOK_MODEL="https://allamllmuksstandard.blob.core.windows.net/llm-data/allam_gen_cleaned/allam_gen_cleaned_by_v5tok.improved/tokenizer/tokenizer.model"
...
BIN_IDX_PATH="https://allamllmuksstandard.blob.core.windows.net/llm-data/allam_gen_cleaned/allam_gen_cleaned_by_v5tok.improved/meglm_tok_v5_improved_bin_idx/"
