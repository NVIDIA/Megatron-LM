...
python examples/data-processing/data_ratio_from_file.py \
 --prefix-paths-from-json "examples/data-processing/data_signature/the_pile_tokenizer_v5_improved.json" \
 ...
 --exclude-iterator-json "examples/pretrain-allam/allam-1b_SlimPajama_mlm/exclude_iterator.json" \
