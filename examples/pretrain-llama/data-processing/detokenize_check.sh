...
AR_FILE="allam_data_2-1_splits-llama2-VE-indexed_data/bin_idx/ar_books_split_00_text_document"
AR_BIN="${AR_FILE}.bin"
AR_IDX="${AR_FILE}.idx"

EN_FILE="allam_data_2-1_splits-llama2-VE-indexed_data/bin_idx/en_books_books_split_02_text_document"
EN_BIN="${EN_FILE}.bin"
EN_IDX="${EN_FILE}.idx"
...
if [ ! -f $TOK_FILE ]; then
    AZURE_TOK="allam_data_2-1_splits-llama2-VE-indexed_data/tokenizer/tokenizer.model"
