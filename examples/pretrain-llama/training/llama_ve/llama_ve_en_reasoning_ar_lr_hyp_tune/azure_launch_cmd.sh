...
do
    sed "s/\${{lr_rate}}/$LR/g" examples/pretrain-llama/training/llama_ve/llama_ve_en_reasoning_ar_lr_hyp_tune/llama_ve_en_reasoning_ar_lr_hyp_tune.yaml > examples/pretrain-llama/training/llama_ve/llama_ve_en_reasoning_ar_lr_hyp_tune/temp.yaml
    cat examples/pretrain-llama/training/llama_ve/llama_ve_en_reasoning_ar_lr_hyp_tune/temp.yaml
