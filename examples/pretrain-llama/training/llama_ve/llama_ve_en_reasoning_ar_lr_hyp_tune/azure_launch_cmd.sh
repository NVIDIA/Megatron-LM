for LR_RATE in 1e-5 2e-5 3e-5 4e-5 5e-5 1e-6
do
    sed "s/\$${{lr_rate}}/$LR_RATE/g" examples/pretrain-llama/training/llama_ve/llama_ve_en_reasoning_ar_lr_hyp_tune/llama_ve_en_reasoning_ar_lr_hyp_tune.yaml > examples/pretrain-llama/training/llama_ve/llama_ve_en_reasoning_ar_lr_hyp_tune/temp.yaml
