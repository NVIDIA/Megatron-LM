...
do
    ...
    echo "{\"en\": $ENG_TOK,\"ar\": $AR_TOK}" > examples/pretrain-llama/training/llama_ve_init_emb_en_reasoning_ar_data_mix_hyp_tune/lang_prob.json
...
--lang-select-prob-json "examples/pretrain-llama/training/llama_ve_init_emb_en_reasoning_ar_data_mix_hyp_tune/lang_prob.json" \
