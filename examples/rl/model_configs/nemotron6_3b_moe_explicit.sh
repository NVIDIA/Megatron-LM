...
# torch-dist checkpoints like geshen's bear mopd-rlvr step_N): replaces
# --use-checkpoint-args with the architecture flags dumped from the nano_sft
# checkpoint (same nano-v3 31B-A3B arch; iter_0000001/common.pt, Jul 2026).
