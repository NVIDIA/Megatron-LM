...
if [ ${MODEL_SIZE} == "1.7B" ]; then
    ...
    DDP=local
    NNODES=128
    MEGATRON_EXTRA_PARAMS="--recompute-method uniform --num-layers-per-virtual-pipeline-stage 5"
    ...
    DDP=local
    NNODES=240
    MEGATRON_EXTRA_PARAMS="--recompute-method uniform --num-layers-per-virtual-pipeline-stage 3 "
    ...
    DDP=local
    NNODES=315
    MEGATRON_EXTRA_PARAMS="--recompute-method uniform --num-layers-per-virtual-pipeline-stage 1 "
