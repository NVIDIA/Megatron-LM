...
def hybrid_builder(args, pre_process, post_process, vp_stage=None, config=None, pg_collection=None):
    ...
    if getattr(args, 'model_recipe', None) is not None:
        ...
        model = HybridModel(
            ...
            layer_type_list_override=recipe.layer_type_list,
            layer_config_list_override=recipe.layer_config_list,
            mtp_layer_pattern_override=recipe.mtp_layer_pattern,
            mtp_num_depths_override=recipe.mtp_num_depths,
