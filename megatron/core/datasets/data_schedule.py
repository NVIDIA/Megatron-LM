...
# NOTE (nightly sync 24_09_2026): legacy hybrid-CP data loader wrapper carried over
# from main. megatron/training/training.py imports it directly. Kept alongside dev's
# sequence-packing schedulers above rather than replacing them.
