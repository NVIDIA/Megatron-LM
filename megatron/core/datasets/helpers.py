...
from megatron.core.datasets.helpers_cpp import build_sample_idx_int32, build_sample_idx_int64, build_sft_sample_idx_int32, build_sft_sample_idx_int64
...
def build_sft_sample_idx(
    ...
    sample_idx_max = max(document_indices.shape[0], sizes.max())
    if sample_idx_max <= numpy.iinfo(numpy.int32).max:
        sample_idx = build_sft_sample_idx_int32(
            sizes,
            document_indices,
            sequence_length,
            num_epochs,
        ...
        sample_idx = build_sft_sample_idx_int64(
            sizes,
            document_indices,
            sequence_length,
            num_epochs,
