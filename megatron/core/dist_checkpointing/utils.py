...
from .mapping import LocalNonpersitentObject, ShardedStateDict, ShardedTensor, StateDict, ShardedTensorFactory
...
def extract_sharded_tensors_or_nonpersistent(
    ...
    return extract_matching_values(
        sharded_state_dict, lambda v: isinstance(v, (ShardedTensor, LocalNonpersitentObject, ShardedTensorFactory))
    )
