...
class FullyShardedDataParallel(_BaseDataParallel):
    ...
    def __init__(
        ...
        if config.fp8_recipe == "mxfp8" and ddp_config.fp8_param_gather:
            self.use_separate_backward_weight = True
        else:
            self.use_separate_backward_weight = False
        ...
        super().__init__(
            ...
            module=MegatronFSDP(
                ...
                use_separate_backward_weight=self.use_separate_backward_weight,
            ),
        )
