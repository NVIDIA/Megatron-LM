...
class EnergyMonitor:
    ...
    def setup(self) -> None:
        ...
        if has_nvml:
            nvmlInit()
            self._handle = nvmlDeviceGetHandleByIndex(get_current_device())
    ...
    def lap(self) -> float:
        ...
        lap_tensor = torch.tensor([lap_energy], dtype=torch.int64, device=get_current_device())
    ...
    def get_total(self) -> float:
        ...
        energy_tensor = torch.tensor([self._total_energy], dtype=torch.int64, device=get_current_device())
