...
class TEDotProductAttention(te.pytorch.DotProductAttention):
    ...
    def forward(
        ...
        if (
            ...
            # Megatron represents end padding as dummy THD sequences. TE DPA sizes THD outputs
            # from cu_seqlens_q/kv, so pass padded boundaries as the effective attention
            # boundaries while keeping the original PackedSeqParams metadata intact for
            # downstream loss/routing paths.
