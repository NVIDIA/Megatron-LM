...
try:
    ...
    try:
        ...
        # The external causal_conv1d package is optional: only the fused pre-GDR
        # backward needs it. Importing this module (and hence GatedDeltaNet) must
        # not fail when it is absent; raise a clear error only if the fused path
        # is actually exercised.
        _causal_conv1d_bwd_function = None
