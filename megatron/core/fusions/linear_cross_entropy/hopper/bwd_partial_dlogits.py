...
try:
    ...
    class BwdPartialDlogits:
        ...
        def kernel(
            ...
            copy_atom_C = cute.make_copy_atom(  #
                cute.nvgpu.warp.StMatrix8x8x16bOp(self.c_layout.is_m_major_c(), 4),  # stmatrix
                self.c_dtype,
            )
            ...
            bSG_sD, bSG_gD = cute.nvgpu.cpasync.tma_partition(
                tma_atom_c, 0, cute.make_layout(1), sepi_for_tma_partition, tCgC_for_tma_partition
            )
    ...
    logging.warning("PyTorch not found. Backward functions will not be available.")
