...
class DynamicInferenceContext(BaseInferenceContext):
    ...
    def __init__(self, model_config: TransformerConfig, inference_config: InferenceConfig):
        ...
        if self.is_hybrid_model:
            ...
            if Symbols.KDA in mamba_inference_state_config.layer_type_list:
    ...
    def reset_metadata(
        ...
        # Preserving a live prefix cache also preserves its monotonic clock and the
        # engine-step counters that drive logging across idle resets. Callers can
        # still request counter preservation independently of prefix caching.
        preserve_counters = preserve_counters or preserve_prefix_cache
