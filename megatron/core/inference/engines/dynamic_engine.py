    ...
    def resume(self):
        ...
        with self.__class__.suspend_resume_ctx(
            ...
            if (
                ...
                # NCCL timeouts. 
                self._run_coroutine_sync(self.expert_parallel_zmq_communicator.all_reduce_max(1))
                self._run_coroutine_sync(self.tensor_parallel_zmq_communicator.all_reduce_max(1))
                self.create_cuda_graphs()
