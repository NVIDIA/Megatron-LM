...
class InferenceClient(AsyncZmqEndpoint):
    ...
    def set_generation_epoch(self, generation_epoch: int):
        ...
        """
        self._isend(Headers.SET_GENERATION_EPOCH, [generation_epoch])
    ...
    async def shutdown(self):
        ...
        This method awaits background tasks and closes the ZMQ sockets. Context
        termination is handled by `AsyncZmqEndpoint.shutdown()` via `_owns_ctx`
        since no external context is passed — the client owns a private context.
        """
