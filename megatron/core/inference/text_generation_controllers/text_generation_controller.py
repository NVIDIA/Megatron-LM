...
class TextGenerationController:
    ...
    async def async_generate_output_tokens(
    ...
    def generate_output_tokens(
        ...
        """Synchronous wrapper for `self.async_generate_output_tokens."""
        loop = get_asyncio_loop(loop)
        return loop.run_until_complete(self.async_generate_output_tokens())
