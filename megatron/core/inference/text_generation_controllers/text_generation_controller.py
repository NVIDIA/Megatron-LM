...
class TextGenerationController:
    ...
    def _dynamic_step_context_init(
        ...
        for label, dtype, on_gpu in context.request_metadata_types:
            self._request_metadata[label].copy_(context.request_metadata[label], non_blocking=True)
    ...
    def _dynamic_step_context_bookkeeping(self) -> Dict[str, Tensor]:
        ...
        active_request_mask = (
            sampled_tokens_cpu != self._request_metadata["termination_id"][active_request_slice]
