...
if has_mem_pool:
    ...
    try:
        ...
        # +++
        # _alloc = CUDAPluggableAllocator(_so_path, "managed_malloc", "managed_free")
        # # unified_memory_mempool = MemPool(allocator=_alloc.allocator())
        # unified_memory_mempool = None
        # +++
        # _alloc = CUDAPluggableAllocator(_so_path, "managed_malloc", "managed_free")
        # unified_memory_mempool = MemPool(_alloc._allocator)
        # <<<
