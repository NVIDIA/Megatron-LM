...
"""Compatibility utilities for deprecated string-defined hybrid architectures.

Native ``layer_config_list`` construction must not import this module.
"""
...
# Backwards-compatible export for callers operating on legacy symbol lists.
get_layer_maps_from_layer_type_list = layer_utils.get_layer_maps_from_layer_type_list
...
def select_pipeline_segment(
    ...
    config lists and uses the native selector in ``hybrid_layer_config`` instead.
