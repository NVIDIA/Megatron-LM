...
def get_hybrid_stage_input_cp_partition_mode(
    config, hybrid_layer_pattern: Optional[str], stage_layer_offset: int
    ...
    layer_layouts = [
        get_hybrid_layer_cp_partition_mode(layer_symbol, config) for layer_symbol in main_pattern
    ]
