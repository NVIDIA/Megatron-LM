...
def _get_gated_delta_product_mamba_layer_spec(in_proj, out_proj):
    """Build the GDP mixer in the hybrid stack's Mamba layer slot."""
    return ModuleSpec(
        module=MambaLayer,
...
gated_delta_product_stack_spec = ModuleSpec(
    ...
    submodules=HybridStackSubmodules(
        ...
        mla_layer=hybrid_stack_spec.submodules.mla_layer,
        csa_layer=hybrid_stack_spec.submodules.csa_layer,
        hca_layer=hybrid_stack_spec.submodules.hca_layer,
        window_layer=hybrid_stack_spec.submodules.window_layer,
...
gated_delta_product_inference_stack_spec = ModuleSpec(
    ...
    submodules=HybridStackSubmodules(
        ...
        mla_layer=hybrid_inference_stack_spec.submodules.mla_layer,
        csa_layer=hybrid_inference_stack_spec.submodules.csa_layer,
        hca_layer=hybrid_inference_stack_spec.submodules.hca_layer,
        window_layer=hybrid_inference_stack_spec.submodules.window_layer,
