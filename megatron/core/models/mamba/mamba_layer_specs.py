...
# NOTE: upstream reduced this module to a re-export of
# megatron.core.models.hybrid.hybrid_layer_specs. This branch keeps the full
# spec here because its DSA-over-GQA integration wires DSGroupedSelfAttention
# into attention_layer, which the hybrid specs do not yet carry. Porting the
# DSA integration to hybrid_layer_specs is deliberate follow-up work.
