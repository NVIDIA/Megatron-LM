...
class VisionModel(torch.nn.Module):
    def __init__(self, vision_transformer_config, vision_transformer_layer_spec, vision_projection_config, vision_projection_layer_spec, vision_projection_type):
        super().__init__()
...
def default_external_feature_model_provider(config, vision_transformer_config, vision_transformer_layer_spec, vision_projection_config, vision_projection_layer_spec, vision_projection_type):
    return VisionModel(vision_transformer_config, vision_transformer_layer_spec, vision_projection_config, vision_projection_layer_spec, vision_projection_type)

# Note: This is under development and may be missing features.
class GPTVisionModel(LanguageModule):
    """GPT Vision multi-modal language model.
