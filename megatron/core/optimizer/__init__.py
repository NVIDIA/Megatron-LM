...
def get_megatron_optimizer(
    ...
    expt_tp_pp_with_egtp_group = process_groups_dict['expt_tp_pp_with_egtp_group']
    ...
    # (intra_expt_dp_no_egtp_group, which aliases the full expert-DP group when EGTP is
