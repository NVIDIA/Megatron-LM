...
class DistributedOptimizer(MixedPrecisionOptimizer):
    ...
    def __init__(
        ...
        if isinstance(optimizer, Adam):
            ...
            self.optimizer_name = 'hybrid_adam'
            self.optimizer_keys = ("param", "exp_avg", "exp_avg_sq")
            ...
            raise Exception(f"Unrecognized optimizer {type(optimizer)}, only Adam, HybridDeviceOptimizer and AdEMAMix are supported for now.")
                ...
                for gbuf_range_map_for_all_buckets in gbuf_range_maps.values():
                    for gbuf_range_map in gbuf_range_map_for_all_buckets:
                        for model_param, param_range_map in gbuf_range_map["param_map"].items():
                            ...
                            if self.optimizer_name in ['adam', 'hybrid_adam']:
