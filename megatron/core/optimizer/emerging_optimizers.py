...
def _create_plain_emerging_optimizer(config, param_groups, eopt_name, model_chunks, pg_collection):
    """Instantiate a plain (unwrapped) emerging optimizer and return it with its init_state_fn."""
...
# ===========================================================================
# Add new optimizers above, then register them here.
# ===========================================================================
