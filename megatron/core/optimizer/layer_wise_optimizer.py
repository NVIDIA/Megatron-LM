...
class LayerWiseDistributedOptimizer(ChainedOptimizer):
    ...
    def sharded_state_dict(
        ...
        # Empty (hence a no-op reducing to the plain DP-zero reset below) whenever GTP is
        # unavailable or off, so this preserves dev's fixed-DP semantics for non-GTP runs.
