    ...
    def __init__(
        ...
        if config.bf16:
            for i in range(len(optimizers)):
                ...
                # (Merge fallback: optimizer.py in this tree distinguishes the base opts via this
                # flag rather than a ``hasattr`` probe, since Float16 also carries the buffer shim.)
