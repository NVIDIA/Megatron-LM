...
class LayerWiseDistributedOptimizer(ChainedOptimizer):
    ...
    def __init__(
        ...
        # DDP owns the parameter-gather schedule. Use the wrapped chunks' policy just like
        # DistributedOptimizer, since heterogeneous modules can have different overlap settings.
