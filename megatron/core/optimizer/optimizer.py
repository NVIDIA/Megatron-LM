...
class MixedPrecisionOptimizer(MegatronOptimizer):
    ...
    def step_with_ready_grads(self) -> bool:
        ...
        if not self.is_stub_optimizer:
            ...
            # (e.g. LayerWiseDistributedOptimizer's Float16 base opts, tagged via
                ...
                for i, param in enumerate(param_group['params']):
                    if param.requires_grad:
                        ...
                        if param.type() in ['torch.cuda.HalfTensor', 'torch.cuda.BFloat16Tensor']:
                            ...
                            # (not the lossy fp8 dequant), matching DistOpt so fp8_param_gather
                            # ON/OFF hold an identical master at iter 0. Falling back to the model
                            # parameter is correct for ordinary BF16/FP16 parameters and older
                            # quantized-tensor implementations.
