...
class OptimizerConfig:
    ...
    applies only to projection splits with complete local query groups and no GTP; other QKV layouts
    fall back to non-TP NS with a warning. Defaults to "blockwise"."""
