...
def initialize_model_parallel(
    ...
    Args:
        ...
        eager_initialize_dynamic_cp_communicators (bool, default = True):
            Run an eager collective on every logical dynamic-CP group. Disable this when
            their communication is routed through an already-initialized parent group.
