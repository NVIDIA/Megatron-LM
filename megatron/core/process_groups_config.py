...
class ProcessGroupCollection:
    ...
    def is_pipeline_first_stage(self, ignore_virtual: bool = True, vp_stage: Optional[int] = None) -> bool:
    ...
    def is_pipeline_last_stage(self, ignore_virtual: bool = True, vp_stage: Optional[int] = None) -> bool:
    ...
    def get_data_parallel_group(self, with_context_parallel: bool = False, partial_data_parallel: bool = False):
    ...
    def get_data_parallel_src_rank(self, with_context_parallel: bool = False, partial_data_parallel: bool = False) -> int:
    ...
    def get_data_parallel_world_size(self, with_context_parallel: bool = False, partial_data_parallel: bool = False) -> int:
