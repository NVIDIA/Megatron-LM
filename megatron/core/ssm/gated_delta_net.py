...
class GatedDeltaNet(MegatronModule):
    ...
    def __init__(
        ...
        # A_log is kept in FP32 for numerical stability
        ...
        # Output layernorm before projection — kept in FP32 to match HF checkpoint precision
        ...
        self.out_norm.to(torch.float32)
