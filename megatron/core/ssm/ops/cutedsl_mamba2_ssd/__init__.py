...
(``_mamba2_ssd_kernel.py``) and wraps it with a THD (token-packed, variable
length) front-end in :mod:`ssd_cutedsl` that mirrors the Triton
``mamba_chunk_scan_combined_varlen`` interface.
"""
