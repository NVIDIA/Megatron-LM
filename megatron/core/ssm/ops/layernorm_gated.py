...
def layer_norm_fwd(x, weight, bias, eps, z=None, out=None, group_size=None, norm_before_gate=True, is_rms_norm=False):
    M, N = x.shape
...
def layer_norm_bwd(dy, x, weight, bias, eps, mean, rstd, z=None, group_size=None,
...
class LayerNormFn(torch.autograd.Function):
    ...
    def backward(ctx, dy):
        ...
        dx, dw, db, dz = layer_norm_bwd(dy, x, weight, bias, ctx.eps, mean, rstd, z, ctx.group_size,
