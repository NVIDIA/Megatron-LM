...
if not HAVE_FA3:
    try:
        from flashattn_hopper import flash_attn_interface as flashattn_hopper_interface

        _flash_attn_forward = flashattn_hopper_interface._flash_attn_forward
        flash_attn3_with_kvcache = flashattn_hopper_interface.flash_attn_with_kvcache
