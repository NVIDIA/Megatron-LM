...
def _pin_mamba_autotuners():
    ...
    kernels = []
    try:
        from megatron.core.ops.ssm.mamba2 import ssd_bmm as r_bmm
        from megatron.core.ops.ssm.mamba2 import ssd_chunk_scan as r_scan
        from megatron.core.ops.ssm.mamba2 import ssd_chunk_state as r_state
        from megatron.core.ops.ssm.mamba2 import ssd_state_passing as r_pass
