...
class Compressor(MegatronModule):
    ...
    def _forward_thd(
        ...
        kv, score = self._project(x)  # (total, 1, coff * head_dim)
            ...
            if self.indexer is not None:
                ...
                if self.training and torch.is_grad_enabled():
                    ...
                    topk_indices_compressed, indexer_loss = FusedDSAIndexerLoss.apply(
                        ...
                        # Current main carries packed-sequence metadata before this flag.
                        None,
                        None,
                        None,
                        None,
    ...
    def _forward_thd_cp(
        ...
        if self.compressor is not None and ratio > 1:
            ...
            if indexer is not None:
                ...
                weights_indexer_cp = indexer._project_weights(indexer_x)
