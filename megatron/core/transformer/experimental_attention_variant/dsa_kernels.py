...
# (merged from PR #5246 "Enable DSA CP and THD hooks"). This is a
# backend-dispatch layer that defers to an optional tilelang/cudnn kernel
# package; it is distinct from the low-level FlashMLA/cuDNN kernels above.
# ---------------------------------------------------------------------------
