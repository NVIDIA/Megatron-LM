...
def build_router_diagnostics(
    ...
    Args:
        ...
        expert_bias: Additive expert-selection correction, or `None` when disabled. Positive
            values favor an expert. Both ordinary bias routing and quantile balancing keep this
            correction in score units because quantile balancing reuses the same buffer.
