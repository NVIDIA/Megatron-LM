...
class MoEAlltoAllTokenDispatcher(MoETokenDispatcher):
    ...
    def sync_meta_dtoh(self, point):
        ...
        This method synchronizes the CUDA event and converts tensors from device to host
        at the specified synchronization point, if it matches the current cuda_sync_point.

        Args:
            point (str): The synchronization point to check against the current cuda_sync_point.
        """
