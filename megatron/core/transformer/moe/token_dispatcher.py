...
class MoEFlexTokenDispatcher(MoETokenDispatcher):
    ...
    def dispatch_preprocess(
        ...
        # For HybridEP, we return None for probs as they are stored in metadata
        # For DeepEP, we return metadata.token_probs for compatibility
        if self.config.moe_enable_hybridep:
...
class MoESyncFreeElasticExpertDispatcher:
    ...
    def __init__(self, config: TransformerConfig, model_comm_pgs: ModelCommProcessGroups):
        self.config = config
