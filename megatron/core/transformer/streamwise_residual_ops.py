...
if HAVE_STREAMWISE_TRITON:
    ...
    def _streamwise_read_fwd_kernel(
        ...
        # requested output dtype. For the FP32-residual Mamba path this is a no-op followed by
        # the desired FP32 -> BF16/FP16 conversion at the store.
...
def streamwise_sigmoid_read(
    ...
    *,
    ...
    if _can_use_streamwise_triton(
        hidden_states, read_logits, num_streams, stream_width, output_dtype=resolved_output_dtype
    ):
