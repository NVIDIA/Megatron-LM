...
class TransformerBlock(GraphableMegatronModule, MegatronModule):
    ...
    def forward(
        ...
        *,
        ...
        # When MTP is enabled we also need the pre-contraction multi-stream
        # tensor downstream so MTP depths can operate per-stream.
        ...
        # When mHC + MTP, return both contracted [s,b,C] (for lm_head) and
        # pre-contraction multi-stream [s,b,n*C] (for MTP input).
