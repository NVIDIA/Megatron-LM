...
class TransformerConfig(ModelParallelConfig):
    ...
    def __post_init__(self):
        ...
        if is_gated_delta_net_variant(self.experimental_attention_variant):
            ...
            if self.experimental_attention_variant == "gdn" and self.gdn_conv_pad_alignment is not None:
            ...
            if self.context_parallel_size > 1:
                ...
                if (
                    ...
                    and self.gdn_conv_pad_alignment is not None
                ):
            ...
            if self.context_parallel_size > 1 and (
                self.experimental_attention_variant != "gdn" or self.linear_cp_mode == "headwise"
            ):
