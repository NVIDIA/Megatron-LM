...
class TransformerConfig(ModelParallelConfig):
    ...
    _output_layer_init_method_is_default: bool = field(init=False, repr=False, compare=False)
    """Whether ``output_layer_init_method`` was omitted and generated by this config."""

    _default_output_layer_init_method: Optional[Callable] = field(
        init=False, repr=False, compare=False
    )
    """Identity of the framework-generated output initializer, if one was generated."""
    ...
    def __post_init__(self):
        ...
        details.
        """
        self._output_layer_init_method_is_default = self.output_layer_init_method is None
        super().__post_init__()
        ...
        self._default_output_layer_init_method = (
            self.output_layer_init_method if self._output_layer_init_method_is_default else None
        )
