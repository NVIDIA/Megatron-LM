...
class TransformerLayer(GraphableMegatronModule, BaseTransformerLayer):
    ...
    def _forward_mlp(self, hidden_states, inference_context=None, padding_mask=None):
        ...
        Args:
            ...
            padding_mask (Tensor, optional): Padding mask for MoE routing. Shape [bsz, seq_length].
        ...
        if (
            ...
            cudagraph_outputs = self.mlp(pre_mlp_layernorm_output, padding_mask=padding_mask_for_moe)
