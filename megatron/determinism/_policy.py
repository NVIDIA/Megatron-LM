...
def is_determinism_configured() -> bool:
    """Whether this process explicitly applied the shared policy.

    This records intent, not current validity. Repeat configure_determinism to
    check config, environment and Torch drift before using another entrypoint.
    """
