...
class GPTModel(MegatronModule):
    ...
    def __init__(
        self, config, num_tokentypes=0, parallel_output=True, pre_process=True, post_process=True
    ):
        args = get_args()
        super().__init__(
            config=config,
    ...
    def forward(
        ...
        *,
        ...
        lm_output = self.language_model(
            input_ids, position_ids, attention_mask, inference_context=inference_context
        )
