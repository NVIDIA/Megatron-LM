        ...
        def build_layer(layer_number):
            if args.transformer_impl == 'local':
                ...
                assert (
                    ...
                    "Unsupported config for apply_query_key_layer_scaling in TransformerEngine. If --apply-query-key-layer-scaling is "  # noqa: E501
                    "provided, set env-var NVTE_APPLY_QK_LAYER_SCALING=1 and you must be using fp16."  # noqa: E501
                )
