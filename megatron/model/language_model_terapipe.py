...
from .transformer_cache import ParallelTransformerWithCache
...
def get_language_model_terapipe(config, num_tokentypes, add_pooler,
    ...
    # Language model.
    language_model = TransformerLanguageModelWithCache(
        config,
        encoder_attn_mask_type,
...
class TransformerLanguageModelWithCache(MegatronModule):
    ...
    def __init__(self,
        ...
        super(TransformerLanguageModelWithCache, self).__init__(share_embeddings_and_output_weights=not args.untie_embeddings_and_output_weights)
        ...
        if self.add_encoder:
            self.encoder = ParallelTransformerWithCache(
                config,
        ...
        if self.add_decoder:
            self.decoder = ParallelTransformerWithCache(
                config,
