...
def _add_distributed_args(parser):
    ...
    group.add_argument('--expert-num-distributed-optimizer-instances', type=int, default=1,
                       help='Number of optimizer instances across the expert-DP domain for MFSDP v2. '
