...
def validate_args(args, defaults={}):
    ...
    if args.perform_rl_step:
        ...
        assert not (
            args.rl_submission_granularity == "B"
            and args.rl_consumption_granularity == "E"
        ), "--rl-submission-granularity B with --rl-consumption-granularity E is not supported."
        assert not (
            args.rl_submission_granularity == "E"
            and args.rl_consumption_granularity == "G"
        ), "--rl-submission-granularity E with --rl-consumption-granularity G is not supported."
