...
def load_args_from_checkpoint(
    ...
    _set_arg('scaling_base_num_layers', force=True, allow_none=True)
    _set_arg('scaling_base_head_dim', force=True, allow_none=True)
    _set_arg('scaling_residual_branch_depth_power', force=True, allow_none=True)
    _set_arg('scaling_hidden_lr_depth_power', force=True, allow_none=True)
    _set_arg('scaling_block_out_proj_init_depth_power', force=True, allow_none=True)
