...
def load_args_from_checkpoint(
    ...
    _set_arg('mtp_layer_pattern', old_arg_name='mtp_hybrid_override_pattern', force=True)  # old name
    _set_arg('mtp_layer_pattern', force=True)  # new mtp name, takes precedence
