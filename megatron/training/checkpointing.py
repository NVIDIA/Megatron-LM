...
def preprocess_fsdp_dtensor_state_dict(args, raw_state_dict, model):
    ...
    # Split the GDN fused in_proj/conv1d projections back into their per-component
    # sub-tensors so each can be independently TP-sharded. No-op for non-GDN models.
