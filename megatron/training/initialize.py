...
def _should_use_dynamic_cp_logical_groups(args):
    """Use topology-only CP groups when TE P2P can communicate through the parent."""
    return (
    ...
    if device_count > 0 and not skip_model_parallel_init:
        if mpu.model_parallel_is_initialized():
            ...
            mpu.initialize_model_parallel(
                ...
                use_dynamic_cp_logical_groups=_should_use_dynamic_cp_logical_groups(args),
