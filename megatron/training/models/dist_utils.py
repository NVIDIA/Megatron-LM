...
def _ddp_wrap(
    ...
    *,
    ...
    with torch.cuda.stream(ddp_stream):
        ...
        # ``reuse_existing=True``. When wrapping multiple VPP chunks, open one ambient
        ...
        is_mfsdp_v2 = use_megatron_fsdp and ddp_config.megatron_fsdp_version == 2
