...
def on_save_checkpoint_start(async_save):
    """Function to be called before save-checkpoint start to generate
    productive metrics to log after ckpt succeeds.
...
def on_save_checkpoint_success(productive_metrics, async_save):
    ...
    checkpoint is persisted for storing productive metrics

    Args:
        productive_metrics (dict): productive related E2E metrics
            generated at the start of save checkpoint
        async_save (bool): apply async checkpointing save
    """
    one_logger = get_one_logger()
            ...
            if need_update:
                ...
                if async_save:
                    ...
                    productive_metrics.update(
                        {
                            'save_checkpoint_sync_time_total_productive': save_checkpoint_sync_time_total_productive,  # noqa: E501
                            'last_successful_save_checkpoint_sync_finish_time': last_successful_save_checkpoint_sync_finish_time,  # noqa: E501
                        }
                    )
    ...
    if one_logger:
        with one_logger.get_context_manager():
            ...
            if one_logger.store_has_key(
                ...
                one_logger.log_metrics(
                    {
                        'first_successful_save_checkpoint_sync_finish_time': save_checkpoint_sync_finish_time  # noqa: E501
                    }
                )
                ...
                e2e_metrics.update(
                    {
                        ...
                        'save_checkpoint_sync_time_total_productive': save_checkpoint_sync_time_total,  # noqa: E501
                        'last_successful_save_checkpoint_sync_finish_time': save_checkpoint_sync_finish_time,  # noqa: E501
                    }
                )
