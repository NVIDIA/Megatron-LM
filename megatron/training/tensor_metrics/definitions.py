...
The distributed metric protocol lives in :mod:`megatron.training.tensor_metrics`. Self-contained
instructional metrics belong in :mod:`megatron.training.tensor_metrics.examples` instead.
"""
