    ...
    def transformer_flops():
        ...
        if args.multi_latent_attention:
            ...
            if args.experimental_attention_variant == "dsv4_hybrid":
                ...
                # DSv4 hybrid replaces dense core attention with sparse attention below.
        ...
        if is_linear_attention_variant(args.experimental_attention_variant):
            ...
            # Sparse attention replaces full core attention. Per token per layer:
            # n_head * positions_attended * v_head_dim, x2 for QK^T and softmax @ V.
            ...
            # Main compressor, for ratio > 0 layers. Two projections per layer
            # (wkv + wgate): hidden -> coff * v_head_dim.
            ...
            if n_layers_r4 > 0:
                ...
                # Indexer compressor (coff=2, wkv + wgate), Q projection, weights
                # projection, and scoring each query against seq_len // 4 compressed positions.
                indexer_term = (
