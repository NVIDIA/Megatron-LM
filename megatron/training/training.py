...
def num_floating_point_operations(
    ...
    def hybrid_flops(total_tokens, seqlen_squared_sum, hidden_size,
                     ...
                     o_groups=None, o_lora_rank=None, csa_window_size=None, seq_length=None,
        ...
        if experimental_attention_variant == "dsv4_hybrid":
            ...
            attn_flops_total = num_attn_layers * mla_attn_layer_flops(
                total_tokens, seqlen_squared_sum, hidden_size, num_attn_heads,
                q_lora_rank, kv_lora_rank, qk_head_dim, qk_pos_emb_head_dim, v_head_dim)
        else:
            attn_flops_total = num_attn_layers * attn_layer_flops(
                total_tokens, seqlen_squared_sum, hidden_size, num_attn_heads, gqa,
        ...
        flops_fwd = (
                ...
                2 * mtp_num_layers * (3 * hidden_size + 2 * hidden_size * hidden_size)
                * total_tokens +
