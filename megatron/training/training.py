...
from megatron.core.optimizer import get_megatron_optimizer, AdamOptimizerConfig, ParamKey
...
def setup_model_and_optimizer(
    ...
    kwargs = {}
    # TODO: Pick this depending on passed in --optimizer.
    ...
    # If using decoupled_lr, construct a config dict object.
