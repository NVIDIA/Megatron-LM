...
from megatron.training import get_args, get_tokenizer, print_rank_0, get_timers
...
def build_bert_model(pre_process=True, post_process=True):
...
def build_datasets(train_val_test_num_samples):
    args = get_args()
...
if __name__ == "__main__":
    ...
    pretrain(build_datasets, build_bert_model, ModelType.encoder_or_decoder, forward_step, args_defaults={'tokenizer_type': 'BertWordPieceLowerCase'})
