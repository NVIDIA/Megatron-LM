...
def _quantize_mx(
    ...
    print(f"orig_shape: {orig_shape}, padded_shape: {padded_shape}")
    print(f"axes: {axes}")
...
if __name__ == "__main__":
    ...
    A_q = _quantize_mx(
            A, scale_bits=8, elem_format='fp8_e4m3',
            shared_exp_method="max", axes=-1, block_size=32,
            round="nearest", flush_fp32_subnorms=False, scaling_control="max"
        )
    print(A_q)
