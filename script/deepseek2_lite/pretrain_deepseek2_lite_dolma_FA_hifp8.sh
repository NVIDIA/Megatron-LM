...
# Training script for deepseek2_lite on dolma with FA_hifp8 quantization
# FA QK quantization with hifp8
...
DATASET_NAME="dolma"
QUANT_TYPE="FA_hifp8"
EXPERIMENT_NAME="dolma_FA_hifp8"
...
parse_arguments() {
    ...
    if [[ "$dry_run" == true ]]; then
        ...
        echo "FA QK quantization with hifp8"
        exec "${cmd[@]}"
    fi
}
