...
# Script: pretrain_deepseek2_lite_dolma_FA_linear_mxfp4.sh
...
CHECKPOINT_PATH=${1:-"checkpoints/deepseek2_lite/pretrain_deepseek2_lite_dolma_FA_linear_mxfp4"}
...
bash examples/deepseek2_lite/train_deepseek2_lite_h100_fp8.sh \
    ...
    "$DATA_ARG" \
    "$DTYPE" \
    2>&1 | tee "${HOST_TENSORBOARD_LOGS_PATH}/training_pretrain_deepseek2_lite_dolma_FA_linear_mxfp4_$(date +'%y-%m-%d_%H-%M-%S').log"
