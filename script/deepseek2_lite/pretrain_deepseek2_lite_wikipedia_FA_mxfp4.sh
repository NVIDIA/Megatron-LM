...
# Training script for deepseek2_lite on wikipedia with FA_mxfp4 quantization
# FA QK quantization with mxfp4
...
QUANT_TYPE="FA_mxfp4"
EXPERIMENT_NAME="wikipedia_FA_mxfp4"
...
parse_arguments() {
    ...
    if [[ "$dry_run" == true ]]; then
        ...
        echo "FA QK quantization with mxfp4"
        exec "${cmd[@]}"
    fi
}
