...
# Training script for deepseek2_lite on wikipedia with linear_hifp8 quantization
# Linear layer quantization with hifp8
...
QUANT_TYPE="linear_hifp8"
EXPERIMENT_NAME="wikipedia_linear_hifp8"
...
parse_arguments() {
    ...
    if [[ "$dry_run" == true ]]; then
        ...
        echo "Linear layer quantization with hifp8"
        exec "${cmd[@]}"
    fi
}
