...
# Script: pretrain_llama31-8b_dolma_bf16.sh
# Quantization Type: bf16
# =============================================================================
...
CHECKPOINT_PATH=${1:-"checkpoints/llama31-8b/pretrain_llama31-8b_dolma_bf16"}
TENSORBOARD_LOGS_PATH=${2:-"tensorboard_logs/llama31-8b_bf16"}
...
bash examples/llama/train_llama3_8b_h100_fp8.sh \
    ...
    "$DATA_ARG" \
    "$DTYPE" \
    2>&1 | tee "${HOST_TENSORBOARD_LOGS_PATH}/training_pretrain_llama31-8b_dolma_bf16_$(date +'%y-%m-%d_%H-%M-%S').log"
