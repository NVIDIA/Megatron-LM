...
# Training script for llama32-1b on dolma with linear_mxfp4 quantization
# Linear layer quantization with mxfp4
...
DATASET_NAME="dolma"
QUANT_TYPE="linear_mxfp4"
EXPERIMENT_NAME="dolma_linear_mxfp4"
...
parse_arguments() {
    ...
    if [[ "$dry_run" == true ]]; then
        ...
        echo "Linear layer quantization with mxfp4"
        exec "${cmd[@]}"
    fi
}
