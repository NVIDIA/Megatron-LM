...
# Training script for llama32-1b on wikipedia with FA_mxfp8 quantization
# FA QK quantization with mxfp8
...
QUANT_TYPE="FA_mxfp8"
EXPERIMENT_NAME="wikipedia_FA_mxfp8"
...
parse_arguments() {
    ...
    if [[ "$dry_run" == true ]]; then
        ...
        echo "FA QK quantization with mxfp8"
        exec "${cmd[@]}"
    fi
}
