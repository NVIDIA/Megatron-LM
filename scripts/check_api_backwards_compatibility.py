...
IGNORED_BREAKAGE_KINDS = ['AttributeChangedValueBreakage']
...
IGNORED_FOR_INIT_METHODS = ['ParameterMovedBreakage']
...
def get_object_path(change) -> str:
    ...
    path = (
        ...
        or getattr(change, 'old_path', None)
    ...
    # Example: "megatron/core/model_parallel_config.py:338: ModelParallelConfig.cpu_offloading_weights: Attribute value was changed"  # noqa: E501
    try:
        ...
        if len(parts) >= 2:
            ...
            # e.g., "megatron/core/model_parallel_config.py" -> "megatron.core.model_parallel_config"  # noqa: E501
...
def main():
    ...
    parser.add_argument(
        '--current', default=None, help='Current git ref (default: working directory)'
    )
    ...
    try:
        ...
        logger.info(
            f"\n   Skipped {skipped_count} exempt | Reporting {len(breaking_changes)} breaking changes"  # noqa: E501
        )
