...
- HIGH SCHEMA/author_missing: Author not specified in metadata (`skills/mcore-build-and-dependency/SKILL.md`)
- MEDIUM QUALITY/quality_correctness: SKILL_SPEC recommended field missing: 'metadata.author' (`skills/mcore-build-and-dependency/SKILL.md`)
