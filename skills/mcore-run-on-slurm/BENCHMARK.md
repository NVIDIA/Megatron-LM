...
Evaluation of the `mcore-run-on-slurm` skill before publication to the NVCARPS ecosystem.
...
- HIGH SCHEMA/author_missing: Author not specified in metadata (`skills/mcore-run-on-slurm/SKILL.md`)
- MEDIUM QUALITY/quality_correctness: SKILL_SPEC recommended field missing: 'metadata.author' (`skills/mcore-run-on-slurm/SKILL.md`)
