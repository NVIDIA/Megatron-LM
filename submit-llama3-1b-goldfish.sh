...
MEGATRON_LM_DIR=/iopsstor/scratch/cscs/$USER/experiments/goldfish/Megatron-LM
DATASET_CACHE_DIR=/iopsstor/scratch/cscs/$USER/datasets/cache

# Logging directories & artifacts
PROJECT_NAME=goldfish-ablation
EXP_NAME=llama3-1b-${SLURM_NNODES}n-${SEQ_LEN}sl-${GBS}gbsz-goldfish
