...
Usage:
    # Step 1: Run batch tests (from the repository root):
    ./tests/functional_tests/run_batch_ci_tests.sh \\
        tests/functional_tests/core/models/gpt/my_test.sh 10

    # Step 2: Wait for jobs to complete, then compute statistics:
    python tests/functional_tests/compute_golden_statistics.py \\
