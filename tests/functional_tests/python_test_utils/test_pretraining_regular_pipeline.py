...
CHECK_THRESHOLDS = {
    ...
    "seq_load_balancing_loss": [common.DeterministicTest(), common.ApproximateTest(atol=0, rtol=0.05)],
    "global_load_balancing_loss": [common.DeterministicTest(), common.ApproximateTest(atol=0, rtol=0.05)],
}
