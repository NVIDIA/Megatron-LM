...
def run_two_chunk_parity(
    layers, extra_kwargs, microbatches=1, use_padding_mask=False, on_plans_built=None
):
...
class TestA2AOverlap:
    ...
    def test_1f1b_schedule_model_chunk_full_recompute(
        ...
        run_two_chunk_parity([3, 2], extra_kwargs, on_plans_built=assert_segments_were_built)
