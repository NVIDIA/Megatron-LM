...
* ``tests/unit_tests/core/determinism/kernels/test_manifest.py`` -- fails the unit-test bucket
...
K = "tests/unit_tests/core/determinism/kernels/"
C = "tests/unit_tests/core/determinism/correctness/"
...
KERNELS: Tuple[KernelEntry, ...] = (
    ...
    KernelEntry(
        ...
        tests=("tests/unit_tests/core/transformer/moe/test_paged_stashing.py",),
        kind="triton",
    ...
    KernelEntry(
        ...
        tests=("tests/unit_tests/core/transformer/moe/test_moe_batch_invariant.py",),
        kind="torch-op",
    ),
    KernelEntry(
    ...
    KernelEntry(
        ...
        tests=("tests/unit_tests/core/ssm/ops/mamba2/test_batch_invariant_decode.py",),
        kind="triton",
        training_path=False,
    ),
    KernelEntry(
    ...
    KernelEntry(
        ...
        tests=(
            ...
            "tests/unit_tests/core/transformer/test_te_layers_batch_invariant.py",
        ),
        kind="triton",
    ),
    KernelEntry(
        ...
        tests=("tests/unit_tests/core/inference/text_generation_controllers/test_mtp_utils.py",),
        kind="triton",
        training_path=False,
    ...
    KernelEntry(
        ...
        "tests/unit_tests/core/transformer/experimental_attention_variant/.",
    ),
)
