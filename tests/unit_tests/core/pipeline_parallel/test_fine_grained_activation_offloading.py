...
def test_fine_grained_activation_offload_with_ep_a2a_overlap_compatibility(
    ...
    `tests/unit_tests/core/pipeline_parallel/test_schedule_chunk_1f1b.py`.
    """
    from megatron.core.models.common.model_chunk_schedule_plan import (
        TransformerModelChunkSchedulePlan,
    )
    from megatron.core.pipeline_parallel.utils import set_streams
    from tests.unit_tests.core.pipeline_parallel.overlap_utils import deterministic_mode
