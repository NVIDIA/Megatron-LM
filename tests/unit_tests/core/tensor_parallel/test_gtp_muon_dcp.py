...
from tests.unit_tests.core.dist_checkpointing import TempNamedDir, setup_model_and_optimizer
...
class TestGTPMuonDCP:
    ...
    def test_gtp_muon_moe_save_load(self, tmp_path_dist_ckpt):
        ...
        from tests.unit_tests.core.dist_checkpointing.utils import initialize_moe_model
    ...
    def test_gtp_muon_moe_native_fp8_save_load(self, tmp_path_dist_ckpt):
        ...
        from megatron.core.tensor_parallel.gtp_api import HAVE_GTP
        from tests.unit_tests.core.dist_checkpointing import utils as _dc_utils
        from tests.unit_tests.core.tensor_parallel.gtp_test_utils import _requires_mxfp8
