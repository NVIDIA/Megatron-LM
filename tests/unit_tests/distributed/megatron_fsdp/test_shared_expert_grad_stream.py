...
def test_shared_expert_grad_processing_bridges_to_default_stream(monkeypatch):
    ...
    shared_param._fsdp_grad_process_on_default_stream = True
    ...
    routed_streams = megatron_fsdp._run_grad_processing_on_default_stream_if_needed(
        [shared_param, other_param], process_grads
    )
