...
def _restore_rng_state():
    """Restore the global RNG after each test.

    The tests below seed the global generators. The CI bucket runs many test files in one
    process, so without this the fixed seed would leak into later, unseeded tests.
    """
