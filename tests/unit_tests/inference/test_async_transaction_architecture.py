...
EXPECTED_VIOLATIONS = {
    ...
    ("async-dataclass-fields", ASYNC_TRANSACTION, "AsyncPendingForwardDecision"),
    ...
    ("async-dataclass-missing", ASYNC_TRANSACTION, "AsyncDecodeLayout"),
    ("async-dataclass-missing", ASYNC_TRANSACTION, "AsyncPendingForwardUse"),
    ...
    ("async-dataclass-slots", ASYNC_TRANSACTION, "AsyncDecodePlan"),
    ...
    ("async-dataclass-slots", ASYNC_TRANSACTION, "AsyncPendingForwardDecision"),
    ...
    ("async-dataclass-unexpected", ASYNC_TRANSACTION, "AsyncLayoutSnapshot"),
    ...
    ("controller-forbidden-lifecycle-import", TEXT_CONTROLLER, "AsyncPendingForwardDecision"),
