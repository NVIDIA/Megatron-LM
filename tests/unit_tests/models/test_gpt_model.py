...
def test_get_transformer_layer_spec_forwards_use_te_activation_func():
    ...
    with (
        patch('megatron.training.models.gpt_builders.get_args', return_value=mock_args),
        patch(
            'megatron.training.models.gpt_builders.get_gpt_layer_with_transformer_engine_spec'
        ) as mock_spec_fn,
    ):
        from megatron.training.models.gpt_builders import _get_transformer_layer_spec
