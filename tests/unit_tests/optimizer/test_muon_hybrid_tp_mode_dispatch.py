...
def _cfg(
    tp_mode: str = 'duplicated', expert_tp_mode: "str | None" = None, split_qkv: bool = False
) -> OptimizerConfig:
    ...
    return OptimizerConfig(
        muon_tp_mode=tp_mode, muon_expert_tp_mode=expert_tp_mode, muon_split_qkv=split_qkv
    )
