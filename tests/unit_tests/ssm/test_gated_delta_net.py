...
try:
    from causal_conv1d.cpp_functions import causal_conv1d_bwd_function as _causal_conv1d_bwd

    HAVE_FUSED_PRE_GDR = True
except ImportError:
    try:
        import causal_conv1d_cuda as _causal_conv1d_cuda

        _causal_conv1d_bwd = _causal_conv1d_cuda.causal_conv1d_bwd
        HAVE_FUSED_PRE_GDR = True
    except ImportError:
        _causal_conv1d_bwd = None
