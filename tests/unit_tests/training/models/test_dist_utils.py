...
class TestDdpWrap:
    ...
    @patch("torch.cuda.stream")
    @patch("megatron.training.models.dist_utils.get_shared_capture_stream")
    def test_does_not_create_capture_stream_for_other_cuda_graph_implementations(
        self, mock_shared_stream, mock_stream_context, mock_config, mock_ddp, cuda_graph_impl
    ):
