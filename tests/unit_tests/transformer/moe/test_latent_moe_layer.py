...
def test_latent_projections_use_owning_tp_group_for_checkpoint_only(monkeypatch):
    ...
    tp_group = _FakeProcessGroup(size=1)
    ep_group = _FakeProcessGroup(size=1)
    gtp_remat_group = _FakeProcessGroup(size=1)
    gtp_replica_group = _FakeProcessGroup(size=1)
    checkpoint_dp_cp_group = _FakeProcessGroup(size=1)
