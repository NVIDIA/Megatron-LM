...
class _FakeSingleRankProcessGroup:
    def rank(self):
        return 0
...
def test_latent_projections_use_owning_tp_group_for_checkpoint_only(monkeypatch):
    ...
    tp_group = _FakeSingleRankProcessGroup()
    ep_group = _FakeSingleRankProcessGroup()
    gtp_remat_group = _FakeSingleRankProcessGroup()
    gtp_replica_group = _FakeSingleRankProcessGroup()
    checkpoint_dp_cp_group = _FakeSingleRankProcessGroup()
