...
from megatron.core.utils import mup_init_method_normal, mup_scaled_init_method_normal
...
class TestMuPInitMethods:
    ...
    def test_mup_init_variance_scaling(self):
        ...
        init_fn = mup_init_method_normal(base_sigma, width_mult)
...
class TestMuPLRScaling:
    ...
    def test_mup_lr_override_has_correct_predicate(self):
        ...
        for param_key, override in overrides.items():
            ...
            # Embedding layer should NOT match (base LR) - fan_in is vocab (finite)
