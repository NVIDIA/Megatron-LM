...
| 7 | Copy `golden_values*.json` from `OUTPUT_PATH` into `tests/functional_tests/test_cases/core/models/gpt/gpt3_mcore_te_tp2_pp1_resume_torch_dist_cp2_nondeterministic/` |
...
- `tests/functional_tests/test_cases/core/models/gpt/gpt3_mcore_te_tp2_pp1_resume_torch_dist_cp2_nondeterministic/golden_values*.json` — updated golden values copied from the first run.
