...
def convert_to_hf(model_path, input_base_path, model_size, tokenizer_path):
    ...
    for layer_i in range(n_layers):
        ...
        if num_shards == 1:
            ...
            # Sharded
            # Note that attention.w{q,k,v,o}, feed_fordward.w[1,2,3], attention_norm.weight and ffn_norm.weight share  # noqa: E501
            # the same storage object, saving attention_norm and ffn_norm will save other weights too, which is  # noqa: E501
            # redundant as other weights will be stitched from multiple shards. To avoid that, they are cloned.  # noqa: E501
...
def _load_checkpoint(queue, args):
    ...
    try:
        ...
        from megatron.training.global_vars import set_args, set_global_variables  # noqa: F401
