...
class MegatronCheckpointSaverBase:
    """Orchestrates saving a Megatron checkpoint using parameters
    received on a multiprocessing queue.
        ...
        if (
            ...
            if self.args.target_expert_parallel_size is not None:
                os.environ["WORLD_SIZE"] = (
                    f'{self.args.target_tensor_parallel_size * self.args.target_pipeline_parallel_size * self.args.target_expert_parallel_size}'  # noqa: E501
                )
            else:
                os.environ["WORLD_SIZE"] = (
                    f'{self.args.target_tensor_parallel_size * self.args.target_pipeline_parallel_size}'  # noqa: E501
                )
    ...
    def save_local_models_to_checkpoint(self):
        ...
        for pp_rank in range(self.args.target_pipeline_parallel_size):
            ...
            # initial the first module in pp stage to get the layer_num, pooler, lm_head. binary_head  # noqa: E501
