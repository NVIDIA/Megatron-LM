...
def get_args():
    ...
    group.add_argument('--input', type=str, required=True, help='Path to input JSON line file')
    group.add_argument(
        '--json-keys',
        nargs='+',
        default=['text'],
...
def process_key(args, key, level):
    ...
    builder = indexed_dataset.IndexedDatasetBuilder(
        bin_file, dtype=indexed_dataset.DType.optimal_dtype(tokenizer.vocab_size)
    )
