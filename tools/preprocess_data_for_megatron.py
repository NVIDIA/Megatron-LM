...
def get_args():
    ...
    group.add_argument('--chunk_size', type=int, default=1, help='chunk size used for retrieval')
    group.add_argument(
        '--chunk_stride_size', type=int, default=1, help='the stride size for neighbor chunks used for retrieval'
    )
